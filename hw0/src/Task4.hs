...
fibonacci = fix executorFibonacci where
...
factorial = fix executorFactorial where
...
-- | The 'mapFix' function applies input function to list elements.
mapFix :: (a -> b) -> [a] -> [b]
mapFix = fix executorMap where
